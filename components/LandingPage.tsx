...
const getClauseGuidance = (projectValue: number) => {
    ...
    return {
        ...
        '상세페이지/광고 디자인': {
            ...
            ip: [
                {
                    title: '조건부 양도형: 유료 소스 라이선스 책임 명시',
        ...
        '캐릭터/일러스트': {
            ...
            ip: [
                ipPortfolio,
                {
                    title: '사용권 부여형: 지정 용도 외 2차 사용 제한',
        ...
        '웹사이트 개발': {
            ...
            revisions: [
                {
                    title: '단계별 검수형: 기획/디자인/개발 단계별 수정',
        ...
        '데이터 분석/AI': {
            ...
            revisions: [
                {
                    title: '단계별 제한형: 데이터/모델/보고서 단계별 수정',
        ...
        '유튜브 영상 편집': {
            ...
            revisions: [
                {
                    title: '횟수 지정형: 총 2회 (가편집 1회, 최종본 1회)',
            ...
            ip: [
                ipPortfolio,
                {
                    title: '사용권 부여형: 저작권은 보유, 채널 사용권 부여',
        ...
        '광고/홍보 영상 제작': {
            ...
            revisions: [
                {
                    title: '단계별 제한형: 콘티/가편집/최종본 단계별 수정',
        ...
        '모션그래픽/애니메이션': {
            ...
            revisions: [
                {
                    title: '단계별 제한형: 스토리보드/시안/영상 단계별 수정',
        ...
        '촬영/드론 촬영': {
         ...
         '카피라이팅': {
            ...
            revisions: [
                {
                    title: '시안 선택형: 선택 시안 1종에 대해 2회 수정',
        ...
        '퍼포먼스 마케팅': {
            ...
            revisions: [
                ...
                {
                    title: '데이터 기반형: 성과 보고서 기반 액션플랜 수정',
            ...
            payment: [
                monthlyPayment,
                {
                    title: '성과 연동형: 목표 ROAS 달성 시 인센티브',
        ...
        'SEO/콘텐츠 마케팅': {
            ...
            revisions: [
                ...
                {
                    title: '성과 목표형: 목표 순위 달성을 위한 상시 수정',
        ...
        '브랜드 마케팅': {
            ...
            revisions: [
                ...
                {
                    title: '가이드라인 기준형: 브랜드 가이드라인 기반 수정',
        ...
        '온라인 강의 제작': {
            ...
            revisions: [
                ...
                {
                    title: '사후 관리형: 수강생 피드백 기반 보충 자료 제작',
...
const LandingPage: React.FC<LandingPageProps> = ({ contractRef, onGoToContract }) => {
    ...
    useEffect(() => {
        if (step === 2 && clauseTitleRef.current) {
            ...
            const headerHeight = header ? header.offsetHeight + 24 : 96; // h-16 (64px) + 24px padding
