...
const LandingPage: React.FC<LandingPageProps> = ({ contractRef, onGoToContract }) => {
    ...
    const ClauseField = ({ clauseKey, title, icon }: { clauseKey: string; title: string; icon: React.ReactElement }) => {
        const suggestions = (guidanceForTask as any)?.[clauseKey] || [];
        ...
        <div className="relative">
            <label htmlFor={clauseKey} className="flex items-center space-x-2 text-lg font-semibold text-slate-100 mb-2">
                ...
                <span>{title}</span>
                <button type="button" onMouseEnter={() => setActiveClauseHelp(clauseKey)} onMouseLeave={() => setActiveClauseHelp(null)} className="group relative">
                    <QuestionMarkCircleIcon className="h-5 w-5 text-slate-500" />
                    {activeClauseHelp === clauseKey && (
            ...
            {suggestions.length > 0 && (
                <div className="mt-4 animate-fade-in-fast">
                    <h3 className="text-sm font-semibold text-fuchsia-400 mb-2 flex items-center space-x-1.5">
                        <LightBulbIcon className="h-4 w-4" />
                        <span>전문가 추천 조항</span>
                    </h3>
                    <div className="space-y-4 p-4 bg-slate-900/50 rounded-lg border border-slate-700">
                        {suggestions.map((item: any, index: number) => (
                            <div key={index} className="bg-slate-800 p-4 rounded-md border border-slate-700/50">
                                <h4 className="font-bold text-md text-fuchsia-400">{item.title}</h4>
                                ...
                                <button 
                                    onClick={() => handleApplySuggestion(clauseKey, item.suggestion)}
                                    className="mt-4 w-full p-2 rounded-md font-semibold bg-fuchsia-600 hover:bg-fuchsia-700 text-white transition-colors text-sm"
                                >
                                    이 조항으로 적용하기
                                </button>
                            </div>
...
을 (작업자): ${formData.freelancerName || '________________'} (서명/인)
  ...
  return (
    <div className="bg-slate-900 text-slate-200">
      ...
      <section ref={contractRef} className="relative overflow-hidden bg-slate-900">
        ...
        <div className="relative max-w-7xl mx-auto py-24 px-4 sm:py-32 sm:px-6 lg:px-8 text-center">
          ...
          <p className="mt-6 text-2xl font-bold text-fuchsia-400 sm:text-3xl">혼자 일해도, 계약만큼은 외롭지 않게.</p>
          <p className="mt-4 max-w-2xl mx-auto text-lg text-slate-300 sm:text-xl">
            구두 계약, 복잡한 서류는 이제 그만. <br /> 링크 하나로 1분 만에 계약하고 당신의 권리를 지키세요.
          </p>
        </div>

        <div className="relative -mt-16 sm:-mt-24 pb-24 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            {/* Step Indicator */}
                ...
                {[1, 2, 3].map(s => (
                    <React.Fragment key={s}>
                        <div className="flex flex-col items-center z-10">
                            ...
                            <p className={`mt-2 text-sm font-semibold ${step >= s ? 'text-fuchsia-400' : 'text-slate-400'}`}>{['기본정보', '세부조항', '검토 및 완성'][s-1]}</p>
                        </div>
                     ...
                     <div className="grid md:grid-cols-2 gap-6">
                        <div className="bg-slate-900/50 p-4 rounded-md border border-slate-700 space-y-2">
                         ...
                         <div className="bg-slate-900/50 p-4 rounded-md border border-slate-700 space-y-2">
                            ...
                            <select id="task" name="task" value={formData.task} onChange={handleFormChange} disabled={!formData.industry} className="w-full bg-slate-800 border border-slate-700 rounded-md p-3 focus:ring-2 focus:ring-fuchsia-500 focus:border-fuchsia-500 disabled:opacity-50">
                        ...
                        <div className="space-y-8 animate-fade-in pt-8 border-t border-slate-700/50">
                            ...
                            <div className="grid md:grid-cols-2 gap-6">
                                <div>
                                    <div className="bg-slate-900/50 p-4 rounded-md border border-slate-700 space-y-2">
                                        ...
                                        <input type="text" id="clientName" name="clientName" value={formData.clientName} onChange={handleFormChange} placeholder="클라이언트 이름 또는 회사명" className="w-full bg-slate-800 border border-slate-700 rounded-md p-3 focus:ring-2 focus:ring-fuchsia-500 focus:border-fuchsia-500" />
                                    </div>
                                ...
                                <div>
                                    <div className="bg-slate-900/50 p-4 rounded-md border border-slate-700 space-y-2">
                                        ...
                                        <input type="text" id="freelancerName" name="freelancerName" value={formData.freelancerName} onChange={handleFormChange} placeholder="본인 이름 또는 활동명" className="w-full bg-slate-800 border border-slate-700 rounded-md p-3 focus:ring-2 focus:ring-fuchsia-500 focus:border-fuchsia-500" />
                                    </div>
                                    <p className="flex items-start gap-2 mt-2 text-xs text-cyan-400">
                                        <LightBulbIcon className="h-4 w-4 flex-shrink-0 mt-0.5 text-cyan-500" />
                            ...
                            <div>
                                <div className="bg-slate-900/50 p-4 rounded-md border border-slate-700 space-y-2">
                                    ...
                                    <input type="text" id="projectName" name="projectName" value={formData.projectName} onChange={handleFormChange} placeholder="예: 2024년 브랜드 리뉴얼" className="w-full bg-slate-800 border border-slate-700 rounded-md p-3 focus:ring-2 focus:ring-fuchsia-500 focus:border-fuchsia-500" />
                                </div>
                                <p className="flex items-start gap-2 mt-2 text-xs text-cyan-400">
                                    <LightBulbIcon className="h-4 w-4 flex-shrink-0 mt-0.5 text-cyan-500" />
                            ...
                            <div>
                                <div className="bg-slate-900/50 p-4 rounded-md border border-slate-700 space-y-4">
                                    ...
                                    <button type="button" onClick={addDeliverable} className="text-sm font-semibold text-fuchsia-400 hover:text-fuchsia-300 flex items-center space-x-1 pt-2"><PlusIcon className="h-4 w-4"/><span>산출물 추가</span></button>
                                </div>
                                <p className="flex items-start gap-2 mt-2 text-xs text-cyan-400">
                                    <LightBulbIcon className="h-4 w-4 flex-shrink-0 mt-0.5 text-cyan-500" />
            ...
            {step === 2 && (
                <div className="bg-slate-800/50 p-8 rounded-2xl border border-slate-700 space-y-8 animate-fade-in">
                   <div>
                        <h2 className="text-2xl font-bold text-slate-100 mb-1">세부 조항 작성</h2>
                        <p className="text-slate-400">분쟁을 막는 핵심 조항들을 꼼꼼하게 작성해 보세요.</p>
                    </div>
                    <div className="space-y-6">
                       <ClauseField clauseKey="scope" title="작업 범위" icon={<ScopeIcon />} />
                       <ClauseField clauseKey="revisions" title="수정" icon={<RevisionsIcon />} />
                       <ClauseField clauseKey="payment" title="대금 지급" icon={<DollarIcon />} />
                       <ClauseField clauseKey="ip" title="저작권" icon={<IPRightsIcon />} />
                       <ClauseField clauseKey="termination" title="계약 해지" icon={<TerminationIcon />} />
                       <ClauseField clauseKey="feedback" title="피드백 및 소통" icon={<FeedbackIcon />} />
                       <ClauseField clauseKey="review" title="기타" icon={<PencilSquareIcon />} />
                   </div>
                    <div className="flex justify-between">
                        <button onClick={() => setStep(1)} className="inline-flex items-center justify-center px-6 py-3 border border-slate-600 text-base font-bold rounded-full text-slate-300 bg-slate-800 hover:bg-slate-700 transition-colors">이전</button>
                        <button onClick={() => setStep(3)} className="inline-flex items-center justify-center px-6 py-3 border border-transparent text-base font-bold rounded-full text-white bg-gradient-to-r from-fuchsia-600 to-pink-600 hover:from-fuchsia-700 hover:to-pink-700 transition-all transform hover:scale-105">다음: 계약서 검토</button>
                    </div>
                </div>
            )}
            ...
            {step === 3 && (
                <div className="bg-slate-800/50 p-8 rounded-2xl border border-slate-700 animate-fade-in">
                    ...
                    <div className="mt-8 relative">
                        <div className={`p-6 bg-slate-900 border border-slate-700 rounded-lg max-h-[60vh] overflow-y-auto transition-all duration-300 ${!notificationClicked ? 'blur-sm select-none' : ''}`}>
                        ...
                        {!notificationClicked && (
                            <div className="absolute inset-0 bg-slate-900/80 backdrop-blur-sm rounded-lg flex flex-col items-center justify-center text-center p-8 space-y-8">
                                ...
                                <button onClick={() => setNotificationClicked(true)} className="inline-flex items-center justify-center px-8 py-4 border border-transparent text-lg font-bold rounded-full text-white bg-gradient-to-r from-fuchsia-600 to-pink-600 hover:from-fuchsia-700 hover:to-pink-700 transition-all transform hover:scale-105">
                    ...
                    <div className="mt-12 flex justify-between">
                         <button onClick={() => setStep(2)} className="inline-flex items-center justify-center px-6 py-3 border border-slate-600 text-base font-bold rounded-full text-slate-300 bg-slate-800 hover:bg-slate-700 transition-colors">이전</button>
                         {notificationClicked && (
      ...
      <section className="py-20 sm:py-24">
         <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center">
              <h2 className="text-3xl font-bold text-slate-100 mb-4">링크 계약, 이렇게 쉬워요</h2>
              <p className="text-lg text-slate-400 max-w-3xl mx-auto">더 이상 만나서 도장 찍을 필요 없어요. FreeZone이 만든 링크 하나면 계약의 모든 과정이 끝납니다.</p>
            </div>
            <div className="mt-20 relative">
              <div className="grid md:grid-cols-3 gap-y-16 md:gap-x-16 text-center">
                
                <div className="relative">
                  <div className="absolute -top-12 left-1/2 -translate-x-1/2 bg-slate-800 border-2 border-fuchsia-500/50 rounded-full h-16 w-16 flex items-center justify-center font-bold text-2xl text-fuchsia-400">1</div>
                  <div className="bg-slate-800/50 p-8 rounded-2xl border border-slate-700 h-full">
                    <DocumentTextIcon className="h-12 w-12 text-fuchsia-400 mx-auto mb-4" />
                ...
                <div className="relative">
                  <div className="absolute -top-12 left-1/2 -translate-x-1/2 bg-slate-800 border-2 border-fuchsia-500/50 rounded-full h-16 w-16 flex items-center justify-center font-bold text-2xl text-fuchsia-400">2</div>
                  <div className="bg-slate-800/50 p-8 rounded-2xl border border-slate-700 h-full">
                    <ShareIcon className="h-12 w-12 text-fuchsia-400 mx-auto mb-4" />
                ...
                <div className="relative">
                  <div className="absolute -top-12 left-1/2 -translate-x-1/2 bg-slate-800 border-2 border-fuchsia-500/50 rounded-full h-16 w-16 flex items-center justify-center font-bold text-2xl text-fuchsia-400">3</div>
                   <div className="bg-slate-800/50 p-8 rounded-2xl border border-slate-700 h-full">
                    <SignatureIcon className="h-12 w-12 text-fuchsia-400 mx-auto mb-4" />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-16 max-w-5xl mx-auto grid md:grid-cols-2 gap-8">
            <div className="bg-slate-800 p-6 rounded-lg border border-slate-700 flex items-start space-x-4">
             ...
             <div className="bg-slate-800 p-6 rounded-lg border border-slate-700 flex items-start space-x-4">
              <ScaleIcon className="h-8 w-8 text-emerald-400 flex-shrink-0 mt-1" />
              <div>
             ...
             <div className="bg-slate-800 p-6 rounded-lg border border-slate-700 flex items-start space-x-4">
              <LightBulbIcon className="h-8 w-8 text-fuchsia-400 flex-shrink-0 mt-1" />
              <div>
             ...
             <div className="bg-slate-800 p-6 rounded-lg border border-slate-700 flex items-start space-x-4">
              <ShieldCheckIcon className="h-8 w-8 text-rose-400 flex-shrink-0 mt-1" />
              <div>
      ...
      <section className="py-20 sm:py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-4xl mx-auto text-center bg-gradient-to-br from-fuchsia-600/20 to-pink-600/20 p-10 rounded-2xl border border-fuchsia-500/30">
